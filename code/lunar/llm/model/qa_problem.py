...
from llm.conversation_generation import ConversationGenerator
...
class QAProblem(Problem):
    ...
    def __init__(self,
        ...
        if self.conversation_generator is not None:
            self.conversation_generator.feature_handler = self.feature_handler
    ...
    def _evaluate(self, x, out, *args, **kwargs):
        ...
        for i, simout in enumerate(simout_list):
            ...
            simout.timestamp = datetime.now().strftime("%Y-%m-%d_%H-%M-%S")
