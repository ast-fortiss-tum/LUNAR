...
DEEPSEEK_AZURE_ENDPOINT_R1_QCBAR = os.getenv("DEEPSEEK_AZURE_ENDPOINT_R1_QCBAR")
...
MODEL_REGISTRY = {
    ...
    "DeepSeek-R1-qcbar": {
        ...
        "azure_endpoint": DEEPSEEK_AZURE_ENDPOINT_R1_QCBAR,
    },
    "DeepSeek-V3-0324": {
    ...
    "DeepSeek-V3-0324-2": {
        "deployment_name": "DeepSeek-V3-0324-2",
        "api_version": "2024-05-01-preview",
        "azure_endpoint": DEEPSEEK_AZURE_ENDPOINT,
    },
}
