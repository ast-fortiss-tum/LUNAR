...
# TODO: is it better to control homophones with probability or just pass the whole text?
...
# def introduce_fillers(input_text, filler_probability = 1):
#     # filler words were taken based on Laserna, C. M., Seih, Y. T., & Pennebaker, J. W. (2014). Um . . . who like says you know: Filler word use as a function of age, gender, and personality. Journal of Language and Social Psychology, 33(3), 328-338.
...
#         # no fillers in the very end
#         if random.random() < filler_probability and i < len(words) - 1:
#             filler = random.choice(fillers)
...
if __name__ == "__main__":
    test_strings = [
        ...
        "Navigate me to BMW World",
        "I am lactose intolerant",
        "Wanna pay with my credit card",
        "How is the traffic?",
        "I prefer scenic routes",
        "Find the fastest route to Munich central train station",
