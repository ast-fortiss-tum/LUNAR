...
class NaviFitnessConversationValidationDimensions(Fitness):
    def __init__(self, 
                llm_type=None,
                weights=[0.5, 0.5],
...
class NaviFitnessConversationEfficiency(Fitness):
    def __init__(self):
        super().__init__()
...
class NaviFitnessConversationEffectiveness(Fitness):
    def __init__(self, field_weights: Optional[dict] = None):
        super().__init__()
        self.content_comparator = NaviFitnessContentComparison(field_weights=field_weights)
