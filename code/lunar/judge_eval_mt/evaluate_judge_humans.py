# reads in the human survey results and computes the kappa agreement between the judges and the human survey results
# compute also the f1 score between the judges and the human survey results (majority vote)
# generate a report with the results
# generates a bar plot with the results

# read in the data in json format

# temporarily go through each conversation in json format in data folder and extract the dimension
# scores (consider this is ground truth)
...
import argparse
from judge_eval_mt.prompts import JUDGE_PROMPT_CONSTRAINTS_NAVI
...
def run_evaluation(folder_path: str, out_folder: str = "./judge_eval_mt/out",
