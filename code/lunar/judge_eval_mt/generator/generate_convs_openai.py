...
from .prompts import SYSTEM_PROMPT_CONTENT_INPUT_HISTORY_DIMS_LEV
...
class IPADims(IPABase):
    ...
    def simulate_turn(
        ...
        **kwargs,
        ...
        effective_system_message = SYSTEM_PROMPT_CONTENT_INPUT_HISTORY_DIMS_LEV.format(
            context=context,
...
def generate_all_conversations(
    ...
    conv_generator = NaviConversationGenerator(feature_handler=feature_handler)
    ...
    for idx, (clarity, req_orient) in enumerate(dimension_pairs, start=1):
        ...
        try:
            ...
            ci = NaviContentInput.model_validate(fv)
...
def main():
    ...
    parser.add_argument(
        ...
        help="Output directory (default: examples/navi/navi-survey/new_data/).",
    )
    parser.add_argument(
